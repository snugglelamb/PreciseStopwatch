...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_stopWatch_t, stringdata) + ofs \
...
QT_MOC_LITERAL(4, 22, 5)
    ...
    "stopWatch\0stop\0\0start\0reset"
};
...
const QMetaObject stopWatch::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_stopWatch.data,
      qt_meta_data_stopWatch,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_stopWatch.stringdata))
